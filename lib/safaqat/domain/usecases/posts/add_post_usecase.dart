...
class AddPostUseCase extends ParamUseCase<Resources<PostDto>, PostBody> {
  final SafaqatRepository _safaqatRepository = Get.find();

  @override
  Future<Resources<PostDto>> call({required PostBody params}) =>
      _safaqatRepository.addPost(body: params);
}
