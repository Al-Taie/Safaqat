...
class AddNewsUseCase extends ParamUseCase<Resources<NewsDto>, Tuple2<PublishNewsBody, List<File>>> {
  final SafaqatRepository _safaqatRepository = Get.find();

  @override
  Future<Resources<NewsDto>> call({required Tuple2<PublishNewsBody, List<File>> params}) =>
