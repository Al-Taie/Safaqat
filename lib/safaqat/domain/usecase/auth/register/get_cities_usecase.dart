...
class GetCitiesUseCase extends ParamUseCase<Resources<List<CityDto>>, int> {
  final SafaqatRepository _safaqatRepository = Get.find();

  @override
  Future<Resources<List<CityDto>>> call({required int params}) =>
      _safaqatRepository.getCities(params);
}
