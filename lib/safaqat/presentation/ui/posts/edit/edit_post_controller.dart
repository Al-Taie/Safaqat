    ...
    if (result.status == Status.success) {
      switch (type) {
        case PostType.opportunity:
          _myPostsController.opportunityPosts.replaceWithUpdate2(
            newItem: result.data!,
            oldItem: post,
            list: _myPostsController.filteredOpportunityPosts,
          );
          break;
        case PostType.request:
          _myPostsController.requestPosts.replaceWithUpdate2(
            newItem: result.data!,
            oldItem: post,
            list: _myPostsController.filteredRequestPosts,
          );
          break;
        default:
          break;
